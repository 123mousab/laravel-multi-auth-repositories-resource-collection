...
function fcmNotification($token, $id, $title, $content, $body, $type, $device)
{
    ...
    $headers = [
        'Authorization: key=' . 'AAAA6cBUfBs:APA91bGl6eXNKnM701RkWk7hr4fFGEfkEpntAoTXlyasY7Mtg8XospsdrzlnHuMw6mJpKBktmkNTdmVVAUqLng5nBXhX8wTgOUF5FmINOJ7GeBH-0k0sjqWmCuHPFOlRT9S_qOrRUkqt',
...
function fcmNotification1($token, $id,$user_id, $title, $content, $body, $type, $device)
{
    $msg = [
        'id' => $id,
        'user_id' => $user_id,
